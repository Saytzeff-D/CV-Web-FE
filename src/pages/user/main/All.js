...
const All = () => {    
    ...
    useEffect(()=>{    
        document.title = `CV Properties - All Properties`
        let filteredProperty = JSON.parse(sessionStorage.getItem('filteredProperties'));
        if (filteredProperty == null) {
            navigate('/');
        } else {
            console.log("Filtered Properties from sessionStorage:", filteredProperty);
    ...
    const fetchProperties = () => {
        let filteredProperty = JSON.parse(sessionStorage.getItem('filteredProperties'));
        if (filteredProperty == null) navigate('/');
        console.log("Filtered Properties from sessionStorage:", filteredProperty);
    ...
    return (
        ...
        <div className="container my-5 py-4">
            ...
            <p className="fw-semibold">
                Home / <span className="text-theme">All Properties</span>
            </p>
            {/* <FilterBar type="all" properties={properties} setFilteredProperties={setFilteredProperties} /> */}
