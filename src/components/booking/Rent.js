            ...
            >
                ...
                <div className="p-4 border-bottom">
                    ...
                    </div>
                    {
                        startDate !== '' && (
                            <>
                            <div class="mt-3"><div className="fw-semibold mt-3">Duration in years</div>
                    ...
                    <div class="mt-3">
                        ...
                        <input disabled type="date" class="form-control rounded-2" value={endDate} />
                    </div>
                </div>
